 ...
 */
final class Version20220628120046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP livreur_id, CHANGE nom nom VARCHAR(50) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE commande ADD livreur_id INT DEFAULT NULL, CHANGE nom nom VARCHAR(50) DEFAULT NULL');
